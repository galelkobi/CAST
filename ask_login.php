						...
						<div class="row" style="margin-top:65px !important;">
							...
							<div class="col-md-3">
								<form action="login.php" method="POST">
									...
									<button class="btn btn-primary btn-user btn-block">Login as an Actor</button>
								</form>
							</div>
							<div class="col-md-3">
								<form action="login.php" method="POST">
								<input type="text" hidden name="type" value="director">
									<button class="btn btn-danger" style="background-color:pink !important;">Login as Director</button>
								</form>
							</div>
							<div class="col-md-3"></div>
						</div>
