    ...
    <div id="testimonial-carousel" class="carousel slide" data-ride="false">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <h2 class="testimonial-text">"I am no longer have to think all day and sort actors every time, in just one week I was able to launch a new production with actors from the site!"</h2>
          <img class="testimonial-image" src="../images/home/vital.jpg" alt="vital-profile">
          <em>Vital Erlich, Director</em>

        </div>
        <div class="carousel-item">
          <h2 class="testimonial-text">"I have never thought it would be so easy to be auditioned! I saved so much money and time! Thank you."</h2>
        ...
        <div class="carousel-item">
          <h2 class="testimonial-text">"Since I started using the site, I have been accepted into a lot of different roles!WOW"</h2>
          <img class="testimonial-image" src="../images/home/einat.jpeg" alt="einat-profile">
          <em>Einat Erlich, Actress</em>
        </div>
        <div class="carousel-item">
          <h2 class="testimonial-text">"OMG! with the help of CAST I was finally ready for auditions!This week I allready got 5 auditions! Amazing!"
          </h2>
...
<footer style="width:100%;
      margin:auto; background:black !importent">
