...
<html lang="en">
  <head>
  	<title>CAST|Actor profile</title>
    <meta charset="UTF-8" />
...
<main id="clients" class="category-clients">
	...
	?>
		...
		<div class="conta row">
			...
			<div class="col-md-8 fullborder" style="border:solid;padding:10px;">
				<div class="row">
					<div class="col-md-8 leftdata">
						<div class="row">
							<div class="col-md-6">
					...
					<div class="col-md-4 rightdata">
						<div class="row">
							<img class="actorimg" src="./images/<?php echo $photo; ?>" style="width:200px; height:200px; text-align: center !important; margin:auto !important; display:flex !important;">
						</div>
